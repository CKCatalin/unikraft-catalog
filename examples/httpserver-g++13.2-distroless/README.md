...
priceless_travis  oci://unikraft.org/base:latest  /http_server  6 seconds ago  running  122M  0.0.0.0:8080->8080/tcp  qemu/x86_64
```

The instance name is `priceless_travis`.
To close the Unikraft instance, close the `kraft` process (e.g., via `Ctrl+c`) or run:

```bash
kraft rm priceless_travis
```
