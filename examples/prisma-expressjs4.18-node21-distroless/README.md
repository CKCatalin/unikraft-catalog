# Node 22 Prisma Server Distroless

This directory contains a Node 22 [`Prisma`](https://www.prisma.io/) implementation using a Chainguard distroless base image running on Unikraft.
...
amazing_harambe  oci://unikraft.org/node:22  /usr/bin/node /usr/src/server.js   14 seconds ago  running  976M   0.0.0.0:3000->3000/tcp   qemu/x86_64
```

The instance name is `amazing_harambe`.
To close the Unikraft instance, close the `kraft` process (e.g., via `Ctrl+c`) or run:

```bash
kraft rm amazing_harambe
```
