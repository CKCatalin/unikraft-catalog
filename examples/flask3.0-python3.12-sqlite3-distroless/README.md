# Python Flask SQLite - Distroless
...
objective_littlemama  oci://unikraft.org/python:3.12  /usr/bin/python3 /app/server.py  5 seconds ago  running  488M  0.0.0.0:8080->8080/tcp  qemu/x86_64
```

The instance name is `objective_littlemama`.
To close the Unikraft instance, close the `kraft` process (e.g., via `Ctrl+c`) or run:

```bash
kraft rm objective_littlemama
```
