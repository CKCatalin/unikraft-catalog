# Node 18 Prisma Server - Distroless

This directory contains a Node 18 [`Prisma`](https://www.prisma.io/) implementation using a Chainguard distroless base image running on Unikraft.
...
romantic_crystal  oci://unikraft.org/node:18  /usr/bin/node /usr/src/server.js   29 seconds ago  running  976M   0.0.0.0:3000->3000/tcp   qemu/x86_64
```

The instance name is `romantic_crystal`.
To close the Unikraft instance, close the `kraft` process (e.g., via `Ctrl+c`) or run:

```bash
kraft rm romantic_crystal
```
